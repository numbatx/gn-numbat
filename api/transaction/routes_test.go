...
import (
	...
	errors2 "github.com/numbatx/gn-numbat/api/errors"
	...
	tr "github.com/numbatx/gn-numbat/data/transaction"
...
func startNodeServer(handler transaction.TxService) *gin.Engine {
	...
	if handler != nil {
		transactionRoute.Use(middleware.WithNumbatFacade(handler))
	}
...
func startNodeServerWrongFacade() *gin.Engine {
	...
	ws.Use(func(c *gin.Context) {
		c.Set("numbatFacade", mock.WrongFacade{})
	})
	transactionRoute := ws.Group("/transaction")
	transaction.Routes(transactionRoute)
	return ws
